...
#define DUAL_X_CARRIAGE
  ...
  #define X2_MAX_POS   234        // The max position of the X2 carriage, typically also the home position
...
//#define CALIBRATION_GCODE
  ...
  #define CALIBRATION_OBJECT_CENTER     { 110, 20,  16.0 } // mm
  #define CALIBRATION_OBJECT_DIMENSIONS {  7.0,  7.0,  5.0 } // mm
  ...
  // Define the pin to read during calibration
    ...
    #define CALIBRATION_PIN PA0            // Define here to override the default pin
 ...
 */
  ...
  //#define TOOLCHANGE_FILAMENT_SWAP
    ...
    #define TOOLCHANGE_FS_RETRACT_SPEED   (2000) // (mm/min) (Unloading)
    #define TOOLCHANGE_FS_UNRETRACT_SPEED (2000) // (mm/min) (On SINGLENOZZLE or Bowden loading must be slowed down)
